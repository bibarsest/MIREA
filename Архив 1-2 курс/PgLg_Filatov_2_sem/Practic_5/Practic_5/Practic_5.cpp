...
int prac_3()
{
    ...
    SetConsoleOutputCP(1251); //rus
    //prac_2();
    cout << "#3. Найти элементы списка, у которых полностью совпадает дата, \nвведенная с клавиатуры, и удалить найденные элементы списка. \nДля корректной работы необходимо ввести значение 10." << endl;
    Record MyTable[10];
    prac_1(MyTable);
    Date INPDate;
    cout << "День: "; cin >> INPDate.Day; cout << "Месяц: "; cin >> INPDate.Month; cout << "Год: "; cin >> INPDate.Year;
    ...
    for (current = head, i = 0; i < 20/*(current)*/; i++, current = current->next) // вывод
    {
        if (bFirst) bFirst = false;
        cout.width(15);
        cout << left << current->info.Name << " "; cout.width(15); cout << current->info.Company << "  Тек. адрес: " << current << " Next=" << current->next << " Prev=" << current->prev << endl;
    }
...
void prac_4()
{
    ...
    ///////////////////////////////////////////////////////////////// TXT //////////////////////////////////////////////////////////////////////////////////////
    // запись в файл
    cout << "Компания: "; cin >> MyTable[total_lines - 1].Company;
    cout << "Наименование: "; cin >> MyTable[total_lines - 1].Name;
    ...
    for (int i = 0; i < total_lines; i++) // задание
    {
...
public:
    ...
    //{
    //    // написал хуйню и заебался
    //    //FILE* file;
    //    //const int total_lines = 10;
    //    //struct Date clRDate1;
    //    //char CC1[total_lines], CC2[total_lines];
    //    ////Record ReadMyTable[total_lines];
    ...
    //    //    if (i == numberofline)
    //    //    {
    //    //        fscanf_s(file, "%s %s %d %f %d %d %d", CC1[i], _countof(CC1[i]), CC2[i], _countof(CC2[i]),
    //    //            &Parts, &Price,
    //    //            &clRDate1.Day, &clRDate1.Month, &clRDate1.Year); clRDate.setDate(clRDate1);
    //    //    }
    //    //}
    //    //Company = CC1[numberofline]; Name = CC2[numberofline];
    //    //// вывод в консоль
    //    //fclose(file);
    //}
